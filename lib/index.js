...
DocsSection.prototype.find = function(params, callback) {
	...
	// `params.useKeys` (internal param) whether use `keys` instead of `values`
	params.keys = params.useKeys === internalParam;
...
DocsSection.prototype.count = function(findParams, callback) {
	...
	// filtering
	findParams.useKeys = !Boolean(findParams.filter) && internalParam;
