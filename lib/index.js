...
function BaseSection(db, prefix) {
	this.db = db;
...
function ValSection(db, prefix) {
	BaseSection.call(this, db, prefix);
}
...
function DocsSection(db, prefix, options) {
	BaseSection.call(this, db, prefix);
	options = options || {};
...
DocsSection.prototype.put = function(doc, callback) {
	var self = this;
