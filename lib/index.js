...
DocsSection.prototype.find = function(params, callback) {
	...
	var dataIter = function(data) {
		if (typeof params.filter === 'function' && !params.filter(data)) {
			return;
		}
		result.push(data);
	};
 ...
 * values to be updated or function which accepts document and return modified
 * document
 * @param {Object} key
